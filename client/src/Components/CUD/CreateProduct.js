                        ...
                        <div id="cudWrapper">
                            ...
                            <div className='cudPostArea'>
                                <div >
                                    ...
                                    <input className="cudInputBox" type="text" onChange={(e) => setName(e.target.value)} />
                                </div>
                                <div >
                                    <h4 className="cudInputField"> Image Link: </h4>
                                    <input className="cudInputBox" type="text" onChange={(e) => setImgURL(e.target.value)} />
                                </div>
                                <div>
                                    <h4 className="cudInputField"> Measurement: </h4>
                                    <input className="cudInputBox" type="text" onChange={(e) => setMeasurement(e.target.value)} />
                                </div>
                                <div>
                                    <h4 className="cudInputField"> Price: </h4>
                                    <input className="cudInputBox" type="text" onChange={(e) => setPrice(e.target.value)} />
                                </div>
                            </div>
                            <button className="cudPostButton" onClick={callCreateProduct}> Add Product </button>
                        </div>
                    </div>
                </Layout>
            </div>
